...
namespace joia_web_dotnet_infra.Migrations
{
    ...
    [Migration("20230326161617_teste5")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("joia_web_dotnet_domain.Administrador", b =>
                {
                    b.HasBaseType("joia_web_dotnet_domain.Pessoa");
            ...
            modelBuilder.Entity("joia_web_dotnet_domain.Cliente", b =>
                {
                    b.HasBaseType("joia_web_dotnet_domain.Pessoa");
            ...
            modelBuilder.Entity("joia_web_dotnet_domain.Administrador", b =>
                {
                    b.HasOne("joia_web_dotnet_domain.Pessoa", null)
                        .WithOne()
                        .HasForeignKey("joia_web_dotnet_domain.Administrador", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("joia_web_dotnet_domain.Cliente", b =>
                {
                    b.HasOne("joia_web_dotnet_domain.Pessoa", null)
                        .WithOne()
                        .HasForeignKey("joia_web_dotnet_domain.Cliente", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
